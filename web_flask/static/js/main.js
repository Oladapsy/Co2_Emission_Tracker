...
async function fetchCo2dailyValue() {
    try {
        const response = await fetch('http://54.162.232.135:5000/api/co2/TodayCycleValue');
...
async function fetchCo23daysValue() {
    try {
        const res = await fetch('http://54.162.232.135:5000/api/co2/records/3limit')
        if (!res.ok) {
...
async function fetchCo2TodayLastYear() {
    try {
        const res = await fetch('http://54.162.232.135:5000/api/co2/compare/today/lastYear')
        if (!res.ok) {
...
async function fetchCo27daysValue() {
    try {
        const res = await fetch('http://54.162.232.135:5000/api/co2/records/7limit')
        if (!res.ok) {
...
fetch('http://54.162.232.135:5000/api/co2/records/7limit')
...
document.getElementById('submitCompareDate').addEventListener('click', function () {
    ...
    const url = `http://54.162.232.135:5000/api/co2/compare/${date1}/${date2}`;
